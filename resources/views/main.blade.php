...
<body class="container mt-4">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="party-rel-tab" data-bs-toggle="tab" data-bs-target="#party-rel-pane" type="button" role="tab" aria-controls="party-rel-pane" aria-selected="false">
            Party Rel
            </button>
        </li>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="loan" role="tabpanel" aria-labelledby="loan-tab">
            <form id="loanForm">@csrf
              <label class="form-label" for="loanCtl2">Ctl2</label>
                <input type="text" class="form-control mb-2" name="Ctl2" placeholder="e.g., 0000" required>
                <label class="form-label" for="loanCtl3">Ctl3</label>
                <input type="text" class="form-control mb-2" name="Ctl3" placeholder="e.g., 0000" required>
                <label class="form-label" for="loanCtl4">Ctl4</label>
                <input type="text" class="form-control mb-2" name="Ctl4" placeholder="e.g., 0000" required>
                <label class="form-label" for="loanAccId">Account ID</label>
                <input type="text" class="form-control mb-2" name="AcctId" placeholder="e.g., 00000001006051" required>
        ...
        <div class="tab-pane fade" id="stopinq" role="tabpanel" aria-labelledby="stopinq-tab">
            <form id="stopInqForm">@csrf
              <label class="form-label" for="stopinqCtl2">Ctl2</label>
                <input type="text" class="form-control mb-2" name="Ctl2" placeholder="e.g., 0000" required>
                <label class="form-label" for="stopinqCtl3">Ctl3</label>
                <input type="text" class="form-control mb-2" name="Ctl3" placeholder="e.g., 0000" required>
                <label class="form-label" for="stopinqCtl4">Ctl4</label>
                <input type="text" class="form-control mb-2" name="Ctl4" placeholder="e.g., 0000" required>
                <label class="form-label" for="stopinqAccId">Account ID</label>
                <input type="text" class="form-control mb-2" name="AcctId" placeholder="e.g., 00000001006051" required>
        ...
        <div class="tab-pane fade" id="stopadd" role="tabpanel" aria-labelledby="stopadd-tab">
            <form id="holdAmountForm">@csrf
              <label class="form-label" for="stopaddCtl2">Ctl2</label>
                <input type="text" class="form-control mb-2" name="Ctl2" placeholder="e.g., 0000" required>
                <label class="form-label" for="stopaddCtl3">Ctl3</label>
                <input type="text" class="form-control mb-2" name="Ctl3" placeholder="e.g., 0000" required>
                <label class="form-label" for="stopaddCtl4">Ctl4</label>
                <input type="text" class="form-control mb-2" name="Ctl4" placeholder="e.g., 0000" required>
                <label class="form-label" for="stopaddAccId">Account ID</label>
                <input type="text" class="form-control mb-2" name="AcctId" placeholder="e.g., 00000001006051Account ID" required>
                <label class="form-label" for="stopaddStopHoldAmount">Stop Hold Amount</label>
                <input type="text" class="form-control mb-2" name="StopHoldAmt" placeholder="e.g., 1">
        ...
        <div class="tab-pane fade" id="holddelete" role="tabpanel" aria-labelledby="holddelete-tab">
            <form id="holdDeleteForm">@csrf
              <label class="form-label" for="holdDeleteCtl2">Ctl2</label>
                <input type="text" class="form-control mb-2" name="Ctl2" placeholder="e.g., 0001" required>
                <label class="form-label" for="holdDeleteCtl3">Ctl3</label>
                <input type="text" class="form-control mb-2" name="Ctl3" placeholder="e.g., 0000" required>
                <label class="form-label" for="holdDeleteCtl4">Ctl4</label>
                <input type="text" class="form-control mb-2" name="Ctl4" placeholder="e.g., 1084" required>
                <label class="form-label" for="holdDeleteAccountId">Account ID</label>
                <input type="text" class="form-control mb-2" name="AcctId" placeholder="e.g., 0000070001524" required>
                <label class="form-label" for="holdDeleteStopHoldSeq">StopHoldSeq</label>
                <input type="text" class="form-control mb-2" name="StopHoldSeq" placeholder="e.g., 09005" required>
    ...
    <!-- Party Rel -->
        ...
        <div class="tab-pane fade" id="party-rel-pane" role="tabpanel" aria-labelledby="party-rel-tab">
          <form id="partyRelForm">@csrf
            <label class="form-label" for="party-rel-paneCtl1">Ctl1</label>
                <input type="text" class="form-control mb-2" name="Ctl1" placeholder="e.g., 0000" required>
                <label class="form-label" for="party-rel-paneCtl2">Ctl2</label>
                <input type="text" class="form-control mb-2" name="Ctl2" placeholder="e.g., 0001" required>
                <label class="form-label" for="party-rel-paneCtl3">Ctl3</label>
                <input type="text" class="form-control mb-2" name="Ctl3" placeholder="e.g., 0000" required>
                <label class="form-label" for="party-rel-paneCtl4">Ctl4</label>
                <input type="text" class="form-control mb-2" name="Ctl4" placeholder="e.g., 1084" required>
                <label class="form-label" for="party-rel-paneCustId">Customer ID</label>
                <input type="text" class="form-control mb-2" name="CustId" placeholder="e.g., 00000001006051" required>
